  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        className={cn(
          "flex flex-1 items-center justify-between py-5 text-left text-sm font-semibold text-ink transition-colors hover:text-brand [&[data-state=open]>svg]:rotate-180",
          className,
        )}
        {...props}
      >
