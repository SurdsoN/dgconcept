    ...
    <section id={id} className="bg-surface-muted py-20">
      <div className="container-page">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3 lg:grid-rows-2">
          <AnimateIn className="relative aspect-square overflow-hidden rounded-2xl bg-gradient-to-br from-ink to-black lg:aspect-auto lg:row-span-2">
            <video
          ...
          {featuredTestimonials.map((t, i) => (
            <AnimateIn key={`${t.name}-${t.location}`} delay={(i + 1) * 80}>
          ...
          <AnimateIn delay={(featuredTestimonials.length + 1) * 80}>
            <Card hover className="flex h-full flex-col items-center justify-center border-none bg-gradient-to-br from-brand to-accent p-6 text-center text-white">
